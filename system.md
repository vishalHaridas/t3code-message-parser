...
- It lists active project threads with title, readable created/updated dates, message count, and a short head/tail latest-user snippet. Each row is width-bounded and separated to avoid terminal wrapping making rows look duplicated.
